...
public class PMSService {
    ...
    public String checkPMS(String recursoNecesario, String tipoEmpleado) {
        System.out.println("Tipo de Empleado solicitado: " + tipoEmpleado);
        System.out.println("Recurso solicitado: " + recursoNecesario);
        System.out.println("Entrando en PMS");
        ...
        new Empleado("JUAN", "CAMARERO", Arrays.asList(true, true, true, true, true, false, false),
                         ...
                         Arrays.asList(LocalTime.of(14, 0), LocalTime.of(14, 0), LocalTime.of(14, 0), LocalTime.of(14, 0),
                                       LocalTime.of(14, 0), LocalTime.MIDNIGHT, LocalTime.MIDNIGHT)),
        ...
        new Empleado("MARIA", "HABITACIONES", Arrays.asList(true, true, true, true, true, false, false),
                        Arrays.asList(LocalTime.of(8, 0), LocalTime.of(8, 0), LocalTime.of(8, 0), LocalTime.of(8, 0), 
                                                     LocalTime.of(8, 0), LocalTime.MIDNIGHT, LocalTime.MIDNIGHT),
                        Arrays.asList(LocalTime.of(16, 0), LocalTime.of(16, 0), LocalTime.of(16, 0), LocalTime.of(16, 0), 
        ...
        for (Recurso recurso : recursos) {
            if (recurso.nombre.equals(recursoNecesario) && recurso.diasAbierto.get(hoyIndex) && horaActual.isAfter(recurso.horaApertura.get(hoyIndex)) && horaActual.isBefore(recurso.horaSalida.get(hoyIndex))) {
                System.out.println("Recurso " + recurso.nombre + " encontrado y abierto.");
                for (Empleado empleado : empleados) {
                    if (empleado.tipoEmpleado.equals(tipoEmpleado) && empleado.diasTrabaja.get(hoyIndex) && horaActual.isAfter(empleado.comienzoTurno.get(hoyIndex)) && horaActual.isBefore(empleado.finalTurno.get(hoyIndex))) {
